...
export declare class AppointmentsController {
    ...
    getMyAppointments(patientId: string, status?: AppointmentStatus): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        patientId: string;
    ...
    getUpcomingAppointments(patientId: string, limit?: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        patientId: string;
    ...
    getAppointment(id: string, patientId: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        patientId: string;
