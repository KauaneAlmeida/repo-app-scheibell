...
async function createTestUsers(clinicId: string) {
  ...
  const testUsers = [
    ...
    {
      id: 'user-staff-clinica',
      email: 'staff@clinica.com',
      name: 'Funcionário Clínica',
  ...
  for (const userData of testUsers) {
    ...
    if (userData.role === UserRole.PATIENT && userData.clinicId) {
      // Data de cirurgia: 14 dias atrás (para ter dados de progresso)
      const surgeryDate = new Date();
      surgeryDate.setDate(surgeryDate.getDate() - 14);
      ...
      console.log(`   ✅ Usuário ${userData.email} criado com registro de paciente`);
    } else {
  ...
  console.log('   Email: admin@clinica.com     | Senha: 123456 | Role: CLINIC_ADMIN');
  console.log('   Email: staff@clinica.com     | Senha: 123456 | Role: CLINIC_STAFF');
  console.log('   Email: terceiro@parceiro.com | Senha: 123456 | Role: THIRD_PARTY');
  console.log('   Email: paciente@teste.com    | Senha: 123456 | Role: PATIENT');
}
