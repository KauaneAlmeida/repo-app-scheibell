...
export class AuthService {
  ...
  async forgotPassword(dto: ForgotPasswordDto) {
    ...
    // Criar registro de reset (expira em 15 minutos)
    ...
    // TODO: Aqui você pode integrar com serviço de email
    ...
    return {
      message: 'Se o email existir, um código de recuperação será enviado',
      success: true,
      ...(isDev && { code }), // Só retorna código em desenvolvimento
    };
  }
  ...
  async resetPassword(dto: ResetPasswordDto) {
    ...
    // Usar transação para atualizar senha e invalidar código
